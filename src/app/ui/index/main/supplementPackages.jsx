            ...
            <div className='container mx-auto'>
                ...
                <div className='grid grid-cols-1 md:grid-cols-3 gap-10 mt-16 max-w-[70%] mx-auto pb-[200px]'>
                    ...
                    >
                        ...
                        <div class="flex items-center justify-center mt-8 -ml-6 ">
                            <h1 class={`font-bold text-center text-6xl mt-2 tracking-tighter font-Roboto ${hoveredDivIndex === 0 ? 'text-amber-500' : 'text-neutral-800'}`}>49$</h1>
                            <p class="ml-1 text-sm text-neutral-600 max-w-[20px]">Per Bottle</p>
                        </div>
                        <h3 class='mt-2 font-bold text-center text-md text-neutral-600'>($299 TOTAL)</h3>
                    ...
                    >
                        ...
                        <div class="flex items-center justify-center mt-8 -ml-6 ">
                            <h1 class={`font-bold text-center text-6xl mt-2 tracking-tighter font-Roboto ${hoveredDivIndex === 1 ? 'text-amber-500' : 'text-neutral-800'}`}>49$</h1>
                            <p class="ml-1 text-sm text-neutral-600 max-w-[20px]">Per Bottle</p>
                        </div>
                        <h3 class='font-bold mt-2 text-center text-md text-neutral-600'>($299 TOTAL)</h3>
                    ...
                    <div class='bg-white rounded-xl shadow-lg p-8 border-amber-500 border-[1px]'>
                        <h2 class='font-bold text-center text-lg text-neutral-800'>6 BOTTLE OF</h2>
                        <h1 class='font-bold text-center text-4xl mt-2 tracking-tighter'>SUXNIX</h1>
                        <h3 class='font-bold text-center mt-2 text-md text-neutral-800'>(6 X 250 Veggie Caps Bottle)</h3>
                        <Image src={pricing03} class="mx-auto h-[160px] w-auto mt-10" alt="pricing03" />
                        <div class="flex items-center justify-center mt-8 -ml-6 ">
                            <h1 class='font-bold text-center text-6xl mt-2 tracking-tighter text-amber-500 font-Roboto'>49$</h1>
                            <p class="ml-1 text-sm text-amber-500 max-w-[20px]">Per Bottle</p>
                        </div>
                        <h3 class='font-bold mt-2 text-center text-md text-neutral-600'>($299 TOTAL)</h3>
